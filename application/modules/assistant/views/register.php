...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen   animated fadeInDown">
        <div>
            ...
            <form class="m-t" role="form" action="asistentes/registrar" method="POST">
                ...
                <div class="form-group">
                    <select class="form-control" name="campus_id" id="">
                        <option value="">Selecciona el campus</option>
                        <option value="1">Bárbula</option>
                        <option value="2">La Morita</option>
                    </select>
