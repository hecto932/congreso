                ...
                <div class="">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form class="form-horizontal" action="asistentes/agregando-pago" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                                <p>Todos los campos son absolutamente obligatorios.</p>
                                <p>Recuerde que sólo se aceptará un pago <b>ÚNICO</b> por lo cual debera estar seguro de los datos introducidos.</p>
